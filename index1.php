...
// REMINDER: This page is to become dashboard. Index should be the login. Redirect user to /$userRole/index.php

    session_start();

    //TODO:  Determine the role of the current user session
    $userRole = 'teacher'; //temporary hard coded role
    $title = 'Dashboard';
    $page = 'dashboard';
