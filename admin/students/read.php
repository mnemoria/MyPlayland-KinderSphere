...
$query = "SELECT * FROM student_info" . $whereClause . " LIMIT ?, ?";
...
// "All" filter
if ($filterStatus === 'All') {
    $allQuery = "SELECT COUNT(*) AS total FROM student_info";
    ...
    $allQuery = "SELECT * FROM student_info LIMIT ?, ?";
    ...
    $totalRecordsQuery = "SELECT COUNT(*) AS total FROM student_info" . $whereClause;
