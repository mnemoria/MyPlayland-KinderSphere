            ...
            <header class="container-fluid mt-4">
                <div class="row">
                    <div class="col-xl-6 col-md-4 mt-2">
                        <h2 class="text-uppercase">Class</h2>
                        <p id="total_count"></p>
                    </div>
                    ...
                    <div class="col-xl-2 col-md-3 mt-2">
                        <button type="button" id="mbtn" class="btn btn-block" data-toggle="modal" data-target="#CreateClass">
...
<?php
    include "modal/add_section.php";
    include "modal/edit_section.php";
