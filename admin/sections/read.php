...
if (!empty($searchInput)) {
    ...
    $whereClause .= " WHERE class_name LIKE '%$searchInput%'";
}
...
$query = "SELECT * FROM class_info" . $whereClause . " LIMIT ?, ?";
...
// "All" filter
if ($filterStatus === 'All') {
    $allQuery = "SELECT COUNT(*) AS total FROM class_info";
    ...
    $allQuery = "SELECT * FROM class_info LIMIT ?, ?";
    ...
    $totalRecordsQuery = "SELECT COUNT(*) AS total FROM class_info" . $whereClause;
