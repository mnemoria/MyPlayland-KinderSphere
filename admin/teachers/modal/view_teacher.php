...
<!-- Create Course Modal -->
<div class="modal fade" id="ViewTeacher" tabindex="-1" role="dialog" aria-labelledby="TeacherModal" aria-hidden="true">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6">
                                    <label>Marital Status: </label><span id="view_maritalStatus"></span>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-6">
                                    <label>ID Number: </label><span id="view_teacherNo"></span>
                                </div>
                                <div class="col-md-6">
                                    <label>Employment Status: </label><span id="view_emStatus"></span>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-12">
