...
if (!empty($searchInput)) {
    ...
    $whereClause .= " WHERE subject_name LIKE '%$searchInput%' OR subject_code LIKE '%$searchInput%'";
}
...
$query = "SELECT * FROM subject_info" . $whereClause . " LIMIT ?, ?";
...
// "All" filter
if ($filterStatus === 'All') {
    $allQuery = "SELECT COUNT(*) AS total FROM subject_info";
    ...
    $allQuery = "SELECT * FROM subject_info LIMIT ?, ?";
    ...
    $totalRecordsQuery = "SELECT COUNT(*) AS total FROM subject_info" . $whereClause;
